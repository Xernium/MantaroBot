...
public class CustomCommandHandler {
    ...
    private final TextContextMongo ctx;
    ...
    public CustomCommandHandler(String prefixUsed, TextContextMongo ctx, String response) {
        this(prefixUsed, ctx, response, "");
    }

    public CustomCommandHandler(String prefixUsed, TextContextMongo ctx, String response, String args) {
        this.ctx = ctx;
    ...
    private interface Func {
        void handle(TextContextMongo ctx, String value, String args);
    }
}
