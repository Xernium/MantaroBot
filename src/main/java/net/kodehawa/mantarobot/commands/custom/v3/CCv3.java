...
public class CCv3 {
    ...
    public static void process(String prefix, TextContextMongo ctx, Node ast, boolean preview) {
        ...
        MessageCreateBuilder builder = new MessageCreateBuilder().addContent(FILTER.matcher(result).replaceAll("-filtered regex-"));
