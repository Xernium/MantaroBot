...
public class InteractionContextMongo<T> extends InteractionContext<T> implements IContextMongo {
    protected final ManagedDatabase managedDatabase = MantaroData.db();

    public InteractionContextMongo(GenericContextInteractionEvent<T> event, I18nContext i18n) {
        super(event, i18n);
    }
