...
public class DBGuild implements ManagedObject {
    ...
    public boolean isPremium() {
        PremiumKey key = MantaroData.db().getPremiumKey(premiumKey);
        ...
        if (key != null) {
            ...
            ISnowflake keyLinkedTo = key.getLinkedTo();
            if (keyLinkedTo != null) {
        ...
        ISnowflake linkedTo = this.mpLinkedTo;
    ...
    public PremiumKey generateAndApplyPremiumKey(int days) {
        ...
        PremiumKey newKey = new PremiumKey(premiumId, TimeUnit.DAYS.toMillis(days),
                currentTimeMillis() + TimeUnit.DAYS.toMillis(days), PremiumKey.Type.GUILD, true, this, null);
    ...
    public void removePremiumKey(ISnowflake keyOwner, String originalKey) {
       premiumKey = null;
    ...
    private ISnowflake mpLinkedTo = null; //user id of the person who linked MP to a specific server (used for patreon checks)
    ...
    public void setPremiumKey(UUID premiumKey) {
    ...
    public ISnowflake getMpLinkedTo() {
        return this.mpLinkedTo;
    }

    public void setMpLinkedTo(ISnowflake mpLinkedTo) {
