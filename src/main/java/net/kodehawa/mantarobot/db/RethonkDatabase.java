...
public class RethonkDatabase extends ManagedDatabase {
    private static final Logger log = LoggerFactory.getLogger(RethonkDatabase.class);
    private final Connection conn;

    public RethonkDatabase(@Nonnull Connection conn) {
        this.conn = conn;
    }
